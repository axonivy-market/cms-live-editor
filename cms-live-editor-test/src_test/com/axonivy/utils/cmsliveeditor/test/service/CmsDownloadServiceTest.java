...
@IvyTest
public class CmsDownloadServiceTest {
  ...
  public void testExportCmsToExcelZipForSingleProject() throws Exception {
    StreamedContent result =
        CmsDownloadService.exportCmsToZip(PROJECT_CMS_A, TEST_APPLICATION, cmsPmvMap, ExportType.EXCEL);
  ...
  public void testExportCmsToExcelZipForAllProjects() throws Exception {
    ...
    StreamedContent result = CmsDownloadService.exportCmsToZip("", TEST_APPLICATION, cmsPmvMap, ExportType.EXCEL);
  ...
  public void testExportCmsToYamlZipForSingleProject() throws Exception {
    StreamedContent result =
        CmsDownloadService.exportCmsToZip(PROJECT_CMS_A, TEST_APPLICATION, cmsPmvMap, ExportType.YAML);
  ...
  public void testExportCmsToYamlZipForAllProjects() throws Exception {
    ...
    StreamedContent result = CmsDownloadService.exportCmsToZip("", TEST_APPLICATION, cmsPmvMap, ExportType.YAML);
